...
func wall0(): #destroys wall 0 when pot 0 is full 
	var walls: Array = [Vector2i(76, 93), Vector2i(76, 94),Vector2i(76, 95),Vector2i(76, 96),Vector2i(76, 97),Vector2i(76, 98),Vector2i(76, 99),Vector2i(76, 100),
	Vector2i(76, 103) , Vector2i(76, 102), Vector2i(76, 101)
	]
...
func wall1(): #destroys wall 1 when pot 1 is full 
	var walls: Array = [Vector2i(72, 93), Vector2i(72, 94),Vector2i(72, 95),Vector2i(72, 96),Vector2i(72, 97),Vector2i(72, 98),Vector2i(72, 99),Vector2i(72, 100),
	Vector2i(72, 103) , Vector2i(72, 102), Vector2i(72, 101)
	]
